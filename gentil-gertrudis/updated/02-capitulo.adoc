...
en conformidad con sus deseos, había accedido en asumir el cargo de institutriz.
...
Sin embargo, deben recordar, que no es siempre _el hacer o no hacer_ algo en particular,
...
Y por otro lado,
hay muchos más cuyo _corazón y voluntad_ desean participar y seguir los deseos mundanos,
...
realmente _son_ todo eso ante los ojos de ese Gran y Santo Ser que no ve como el hombre ve;
...
No había nada que Harriet y Charlotte temieran o respetaran (en cierto grado)
